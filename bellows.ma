...
//Name: bellows.ma
//Last modified: Tue, Feb 08, 2011 08:49:40 PM
//Codeset: 1252
requires maya "2010";
...
createNode mesh -n "pCylinderShape3" -p "|bottom_flat_bellows|pCylinder3";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode mesh -n "pCylinderShape1" -p "|bottom_flat_bellows|pCylinder1";
...
createNode transform -n "top_flat_bellows1";
...
createNode transform -n "pCube3" -p "top_flat_bellows1";
	setAttr ".t" -type "double3" 0 0 -3.2 ;
	setAttr ".s" -type "double3" 1 0.2 2.3 ;
createNode mesh -n "pCubeShape3" -p "|top_flat_bellows1|pCube3";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pCylinder3" -p "top_flat_bellows1";
	setAttr ".t" -type "double3" 0 0 -5.5 ;
	setAttr ".s" -type "double3" 1 0.1 1 ;
createNode mesh -n "pCylinderShape3" -p "|top_flat_bellows1|pCylinder3";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pCylinder1" -p "top_flat_bellows1";
	setAttr ".s" -type "double3" 2 0.1 2 ;
createNode mesh -n "pCylinderShape1" -p "|top_flat_bellows1|pCylinder1";
	addAttr -ci true -sn "mso" -ln "miShadingSamplesOverride" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "msh" -ln "miShadingSamples" -min 0 -smx 8 -at "float";
	addAttr -ci true -sn "mdo" -ln "miMaxDisplaceOverride" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "mmd" -ln "miMaxDisplace" -min 0 -smx 1 -at "float";
...
connectAttr "polyCube3.out" "|bottom_flat_bellows|pCube3|pCubeShape3.i";
connectAttr "deleteComponent10.og" "|bottom_flat_bellows|pCylinder3|pCylinderShape3.i"
		;
connectAttr "deleteComponent7.og" "|bottom_flat_bellows|pCylinder1|pCylinderShape1.i"
		;
...
connectAttr "|bottom_flat_bellows|pCylinder1|pCylinderShape1.wm" "polyCut1.mp";
connectAttr "polyCut1.out" "deleteComponent3.ig";
connectAttr "deleteComponent3.og" "polyBridgeEdge4.ip";
connectAttr "|bottom_flat_bellows|pCylinder1|pCylinderShape1.wm" "polyBridgeEdge4.mp"
		;
connectAttr "polyBridgeEdge4.out" "polyBridgeEdge7.ip";
connectAttr "|bottom_flat_bellows|pCylinder1|pCylinderShape1.wm" "polyBridgeEdge7.mp"
		;
connectAttr "polyBridgeEdge7.out" "polyBridgeEdge8.ip";
connectAttr "|bottom_flat_bellows|pCylinder1|pCylinderShape1.wm" "polyBridgeEdge8.mp"
		;
connectAttr "polyBridgeEdge8.out" "polyBridgeEdge9.ip";
connectAttr "|bottom_flat_bellows|pCylinder1|pCylinderShape1.wm" "polyBridgeEdge9.mp"
		;
connectAttr "polyBridgeEdge9.out" "polyBridgeEdge10.ip";
connectAttr "|bottom_flat_bellows|pCylinder1|pCylinderShape1.wm" "polyBridgeEdge10.mp"
		;
connectAttr "polyBridgeEdge10.out" "polyBridgeEdge11.ip";
connectAttr "|bottom_flat_bellows|pCylinder1|pCylinderShape1.wm" "polyBridgeEdge11.mp"
		;
...
connectAttr "|bottom_flat_bellows|pCylinder1|pCylinderShape1.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "pCubeShape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "pCubeShape2.iog" ":initialShadingGroup.dsm" -na;
connectAttr "pCylinderShape2.iog" ":initialShadingGroup.dsm" -na;
connectAttr "|bottom_flat_bellows|pCube3|pCubeShape3.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|bottom_flat_bellows|pCylinder3|pCylinderShape3.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|top_flat_bellows1|pCube3|pCubeShape3.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|top_flat_bellows1|pCylinder3|pCylinderShape3.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|top_flat_bellows1|pCylinder1|pCylinderShape1.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|bottom_flat_bellows|pCube3.msg" ":hyperGraphLayout.hyp[1].dn";
connectAttr "|bottom_flat_bellows|pCylinder3.msg" ":hyperGraphLayout.hyp[2].dn";
connectAttr "|bottom_flat_bellows|pCylinder1.msg" ":hyperGraphLayout.hyp[3].dn";
// End of bellows.ma
