...
//Name: mobile.ma
//Last modified: Tue, Feb 08, 2011 08:52:35 PM
//Codeset: 1252
requires maya "2010";
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "crosspiece";
...
createNode mesh -n "pSphereShape1" -p "pSphere1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "ballToy";
...
createNode mesh -n "ballToyShape" -p "ballToy";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "cubeToy";
...
createNode mesh -n "pCylinderShape3" -p "pCylinder3";
	...
	setAttr ".cd" -type "dataPolyComponent" Index_Data Edge 0 ;
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
createNode transform -n "cylinderToy";
...
createNode mesh -n "pCylinderShape5" -p "pCylinder5";
	...
	setAttr ".cd" -type "dataPolyComponent" Index_Data Edge 0 ;
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
createNode transform -n "pyramidToy";
