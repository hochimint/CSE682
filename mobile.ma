...
//Name: mobile.ma
//Last modified: Mon, Feb 14, 2011 11:03:53 AM
//Codeset: 1252
requires maya "2010";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -34.581209018861969 1.3190909209478079 7.2243909578177146 ;
	setAttr ".r" -type "double3" -2.1383527296041343 -78.200000000000671 -1.9441418628978905e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 35.352395149059852;
...
createNode transform -n "crosspiece" -p "group1";
	setAttr ".t" -type "double3" 0 5 0 ;
createNode transform -n "pCube1" -p "crosspiece";
	setAttr ".s" -type "double3" 1 1 20 ;
...
createNode transform -n "pCube2" -p "crosspiece";
...
createNode transform -n "pCube3" -p "crosspiece";
...
createNode mesh -n "pSphereShape1" -p "pSphere1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "ballToy" -p "group1";
	setAttr ".t" -type "double3" 0 2.8 -10 ;
	setAttr ".s" -type "double3" 0.1 2.5 0.1 ;
createNode mesh -n "ballToyShape" -p "ballToy";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "cubeToy" -p "group1";
createNode transform -n "pCube4" -p "cubeToy";
	setAttr ".t" -type "double3" 0 0 10 ;
...
createNode mesh -n "pCubeShape4" -p "pCube4";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "pCylinder3" -p "cubeToy";
	setAttr ".t" -type "double3" 0 2.8 10 ;
	setAttr ".s" -type "double3" 0.1 2.5 0.1 ;
createNode mesh -n "pCylinderShape3" -p "pCylinder3";
	...
	setAttr ".cd" -type "dataPolyComponent" Index_Data Edge 0 ;
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
createNode transform -n "cylinderToy" -p "group1";
createNode transform -n "pCylinder1" -p "cylinderToy";
...
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "pCylinder5" -p "cylinderToy";
	setAttr ".t" -type "double3" -10 2.8 0 ;
	setAttr ".s" -type "double3" 0.1 2.5 0.1 ;
createNode mesh -n "pCylinderShape5" -p "pCylinder5";
	...
	setAttr ".cd" -type "dataPolyComponent" Index_Data Edge 0 ;
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
createNode transform -n "pyramidToy" -p "group1";
createNode transform -n "pPyramid1" -p "pyramidToy";
	setAttr ".t" -type "double3" 10 0 0 ;
	setAttr ".s" -type "double3" 2 2 2 ;
createNode mesh -n "pPyramidShape1" -p "pPyramid1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "pCylinder4" -p "pyramidToy";
	setAttr ".t" -type "double3" 10 2.8 0 ;
	setAttr ".s" -type "double3" 0.1 2.5 0.1 ;
...
connectAttr "polyCylinder2.out" "ballToyShape.i";
...
connectAttr "ballToyShape.iog" ":initialShadingGroup.dsm" -na;
