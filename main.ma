...
//Name: main.ma
//Last modified: Mon, Feb 14, 2011 11:59:01 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.0063438776692273 14.309797309237045 80.096716046631826 ;
	setAttr ".r" -type "double3" -47.492240124907916 262.14997334951119 2.5444437451708134e-014 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 23.265883192637691;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 22.506242631052444 100.09999999999998 82.470933910098665 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 107.11664515483218;
...
createNode renderLayerManager -n "renderLayerManager";
	setAttr -s 16 ".rlmi[1:15]"  3 16 2 5 6 1 7 8 
		9 10 11 12 13 14 15;
	setAttr -s 4 ".rlmi";
