...
//Name: bowlingBall.ma
//Last modified: Tue, Feb 01, 2011 09:44:02 PM
//Codeset: 1252
requires maya "2010";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 57.230885907738738 -29.531796507620648 -18.395665520541357 ;
	setAttr ".r" -type "double3" 24.381182771532139 113.69456061607086 0 ;
	setAttr ".rp" -type "double3" 0 3.1086244689504383e-015 0 ;
	setAttr ".rpt" -type "double3" 3.5739380444772898e-014 3.7567799087135748e-015 -3.85071703786889e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 56.639458456808875;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 9.9914309023932901 -6.1507268218567894 2.3356568065069574 ;
...
createNode transform -n "pCylinder2";
	setAttr ".t" -type "double3" -2.5 5 -12.7 ;
	setAttr ".r" -type "double3" 90 0 0 ;
...
createNode mesh -n "polySurfaceShape2" -p "transform6";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "bowlingBall";
createNode mesh -n "bowlingBallShape" -p "bowlingBall";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode groupId -n "groupId12";
	setAttr ".ihi" 0;
createNode phong -n "bowlingBallShadder";
createNode shadingEngine -n "phong1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode stucco -n "stucco1";
	setAttr ".c1" -type "float3" 0.059010006 0.060518868 0.56199998 ;
	setAttr ".c2" -type "float3" 0.11430702 0.14387091 0.75700003 ;
...
connectAttr "polyBoolOp3.out" "bowlingBallShape.i";
...
connectAttr "pCylinderShape3.o" "polyBoolOp1.ip[1]";
connectAttr "pSphereShape1.wm" "polyBoolOp1.im[0]";
connectAttr "pCylinderShape3.wm" "polyBoolOp1.im[1]";
...
connectAttr "pCylinderShape2.o" "polyBoolOp2.ip[1]";
connectAttr "polySurfaceShape1.wm" "polyBoolOp2.im[0]";
connectAttr "pCylinderShape2.wm" "polyBoolOp2.im[1]";
...
connectAttr "pCylinderShape1.o" "polyBoolOp3.ip[1]";
connectAttr "polySurfaceShape2.wm" "polyBoolOp3.im[0]";
connectAttr "pCylinderShape1.wm" "polyBoolOp3.im[1]";
connectAttr "polyBoolOp2.out" "groupParts5.ig";
connectAttr "groupId9.id" "groupParts5.gi";
connectAttr "polyCylinder1.out" "groupParts6.ig";
connectAttr "groupId11.id" "groupParts6.gi";
connectAttr "stucco1.oc" "bowlingBallShadder.c";
connectAttr "bowlingBallShadder.oc" "phong1SG.ss";
connectAttr "bowlingBallShape.iog" "phong1SG.dsm" -na;
connectAttr "phong1SG.msg" "materialInfo1.sg";
connectAttr "bowlingBallShadder.msg" "materialInfo1.m";
connectAttr "stucco1.msg" "materialInfo1.t" -na;
connectAttr "place3dTexture1.wim" "stucco1.pm";
connectAttr "phong1SG.pa" ":renderPartition.st" -na;
connectAttr "bowlingBallShadder.msg" ":defaultShaderList1.s" -na;
